 ...
 * The word count example read a file from the an input file and count all the words in the file. 
 * The present version is based in java 8 lambda expressions
 */
